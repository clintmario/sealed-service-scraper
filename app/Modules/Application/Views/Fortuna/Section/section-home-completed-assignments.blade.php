<div class="vc_row wpb_row vc_row-fluid vc_custom_1427986969472"><div class="dark_links wpb_column vc_column_container"><div class="vc_column-inner vc_custom_1472575963813"><div class="wpb_wrapper"><h2 class="boc_heading no_text_transform letter_spacing_negative al_left"  style="margin-bottom: 20px;margin-top: 0px;font-size: 30px;"><span><strong style="color: #003366;">My <span style="color: #f51149">Learning</span></strong></span>
                ...
                <div class="newtabs clearfix horizontal  minimal_style" style="display: block; width: 100%; margin: 0px; opacity: 1;">
                    <ul class="resp-tabs-list">
                        <li onclick="location.href='/home';" class="resp-tab-item" aria-controls="tab_item-0" role="tab" style="background: #fdfdfd;"><a href="{{ url("/home") }}" style="text-decoration: none;"><span class="icon icon-note2" style="color: #333;"></span><span style="color:333;"> Pending Assignments</span></a></li>
                        <li onclick="location.href='/home/completed_assignments';" class="resp-tab-item resp-tab-active" aria-controls="tab_item-1" role="tab" style="background: #005ed3;"><a href="{{ url("/home/completed_assignments") }}" style="text-decoration: none;"><span class="icon icon-check" style="color: white;"></span><span style="color: white;"> Completed Assignments</span></a></li>
                        ...
                        <tr @if($index % 2 == 0) class="odd" @endif>
                            ...
                            <div class="circ_numbers_holder  center small_counter ">
                                <div class="circ_counter" data-color="#005ed3" data-angle="" data-size="120" data-white_text="0">
                                    ...
                                    <div class="circ_counter_text_holder" style="font-size: 30px; top: 20px;"><span class="circ_counter_text" id="circ_counter_text4520">{{ $assignment->progress }}</span><span class="counter_percent_sign heading_font shown">%</span></div>
