                    ...
                    <div class="col span_1_of_3 info_item isotope_element web-development wordpress-themes">
                            <div class="portfolio_animator_class boc_anim_hidden boc_bottom-to-top boc_start_animation" style="transition-delay: 2750ms; border: 1px solid gray">
                                <div class="pic_info type4" style="height: 350px;">
                                    <a href="//{{ Config::get('module.app_segment') }}/courses?subject_id={{ $subject->subject_id  }}" title="" class="pic_info_link_type4" style="text-decoration: none;">
                                        ...
                                        <div class="pic  img_hover_effect4" style="{{ $boxStyle }}"><div class="plus_overlay"></div><div class="plus_overlay_icon"></div>
                                            <img width="1200" height="800" src="//{{ Config::get('module.app_segment') }}/fortuna/images/open-book.png" class="attachment-full size-full wp-post-image" alt="{{ $subject->subject }}" title="{{ $subject->subject }}" >
                                        </div>
                                    </a>
                                        ...
                                        <div class="info_overlay_padding">
                                            <div class="info_desc">
                                                <h3 style="text-transform: none; font-weight: bold;">
                                                    <a href="//{{ Config::get('module.app_segment') }}/courses?subject_id={{ $subject->subject_id  }}" title=""  style="text-decoration: none;">{{ $subject->subject }}</a>
                                                </h3>
                                                <p>
                                                ...
                                                <span style="margin-left:2px; color: darkgreen; font-size: 14px;">
                                                    <small>{{ $subject->statsString }}</small>
                                                </span>
                                                </p>
                                            </div>
                                        </div>
